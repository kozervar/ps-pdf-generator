...
function exit (error) {
    ...
    if (error) system.stderr.write('PHANTOM: ' + (message || 'Unknown Error ' + error) + '\n');
...
page.onLoadFinished = function (status) {
    ...
    var filename = options.filename || (options.directory || './tmp') + '/PHANTOM-' + system.pid + '.' + fileOptions.type;
